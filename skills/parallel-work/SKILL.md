...
3. Validate a request description with `${CODEX_HOME:-$HOME/.codex}/skills/pennix-skills/parallel-work/scripts/build_request.py`, then render one worker brief with
