...
3. Validate a request description with `${CODEX_HOME:-$HOME/.codex}/skills/parallel-work/scripts/build_request.py`, then use the current Trellis fork's documented channel API.
