...
本参考记录 CodeGraph 当前 catalog component key 的源码契约。catalog ref 变化时，必须重新核对以下源码锚点并更新本文件。
...
- `colbymchenry/codegraph` 的 approved catalog ref 下 `src/mcp/`
- `colbymchenry/codegraph` 的 approved catalog ref 下 `src/project-config.ts`
- `colbymchenry/codegraph` 的 approved catalog ref 下 `src/installer/`
