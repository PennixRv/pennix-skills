...
```sh
python3 "${PENNIX_SKILLS_ROOT:-${CODEX_HOME:-$HOME/.codex}/skills/pennix-skills}/codegraph-project-setup/scripts/prepare_project.py"
```
...
```sh
python3 "${PENNIX_SKILLS_ROOT:-${CODEX_HOME:-$HOME/.codex}/skills/pennix-skills}/codegraph-project-setup/scripts/prepare_project.py" --apply
```
